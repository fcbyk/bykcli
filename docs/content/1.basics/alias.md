...
description: alias 提供命令别名功能，支持通过配置文件定义命令映射
badges:
  - value: 源码
    icon: lucide:code
    to: https://github.com/fcbyk/bykcli/blob/main/src/bykcli/infra/aliases.py
    target: _blank
---
...
```json
{
  "开发": {
    ...
    "构建": {
      "前端": {
        "cmd": "pnpm run build",
        "cwd": "/Users/coke/repo/bykcli/web-ui"
      },
      "后端": "python -m build"
    }
  },
